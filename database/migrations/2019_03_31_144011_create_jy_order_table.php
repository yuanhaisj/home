...
class CreateJyOrderTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('jy_order', function (Blueprint $table) {
            ...
            $table->enum('shipping_status',[1,2,3,4])->default(1)->comment('1 待发货 2 已发货 3 已收货 4 退货');
            $table->enum('pay_status',[1,2,3])->default(1)->comment('订单1 未支付  2 支付中 3、支付成功');
            ...
            $table->timestamp('confirm_time')->comment('订单确认时间');
