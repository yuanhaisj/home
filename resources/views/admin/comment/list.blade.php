            ...
            <div class="table-responsive">
                <table class="table table-primary  mb30">
                    ...
                    <tr>
                        ...
                        <td>{{$val->goods_name or '未知商品'}}</td>
                        <td>{{$val->username or 'admin'}}</td>
                        <td><img  style="width:60px;" src="{{$val->image_url or '/image/photos/media2.png'}}"></td>
                        <td>2</td>
                        <td>{{$val->content or null}}</td>
                        <td>
                            <a class="btn btn-sm btn-success" href="/admin/comment/del/{{$val->id}}">删除
                            </a>
                        </td>
                    </tr>
                    @endforeach
